...
#define NO_FORMAT_BASE  DISABLE_WARNING(-Wformat)

#ifdef HAVE_FORMAT_TRUNCATION
#define NO_FORMAT  NO_FORMAT_BASE DISABLE_WARNING(-Wformat-truncation)
#else
#define NO_FORMAT  NO_FORMAT_BASE
#endif

#define NO_FORMAT_WARNINGS_PUSH DIAGNOSTIC_PUSH NO_FORMAT
