...
DECLARE_TEST(t_array_relative_10)
{
  ...
  rc = SQLPrepare(hstmt, SC_NTS("insert into t_array_relative_10 values(?,?)"));
  mystmt(hstmt, rc);
...
DECLARE_TEST(t_relative_1)
{
  ...
  rc = SQLPrepare(hstmt, SC_NTS("insert into t_relative_1 values(?)"));
  mystmt(hstmt, rc);
...
DECLARE_TEST(t_array_relative_2)
{
  ...
  rc = SQLPrepare(hstmt, SC_NTS("insert into t_array_relative_2 values(?)"));
  mystmt(hstmt, rc);
...
DECLARE_TEST(t_absolute_1)
{
  ...
  rc = SQLPrepare(hstmt, SC_NTS("insert into t_absolute_1 values(?)"));
  mystmt(hstmt, rc);
...
DECLARE_TEST(t_absolute_2)
{
  ...
  rc = SQLPrepare(hstmt, SC_NTS("insert into t_absolute_2 values(?)"));
  mystmt(hstmt, rc);
