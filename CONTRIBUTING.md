...
* Set the following environment variables (optional):
  ...
  * TEST_DRIVER = <the name of ODBC driver as registered in odbcinst.ini> (default = MatrixOne ODBC X.Y Driver, where X.Y is the major/minor version of the driver)
